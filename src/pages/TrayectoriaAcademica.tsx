...
export function TrayectoriaAcademica() {
 ...
 <h2 className="text-2xl md:text-3xl font-heading text-gray-300 mb-10">
 {t('acad.subtitle')}
 </h2>
 ...
 <span className="text-2xl font-heading">{t('acad.uni.1')}</span>
 </div>
 <div className="p-8 border border-gray-100 bg-gray-50 flex items-center">
 <span className="text-2xl font-heading">{t('acad.uni.2')}</span>
 </div>
 </div>
 </section>
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
 {[1, 2, 3, 4, 5, 6].map((num) => (
 <div key={num} className="p-8 border border-gray-200 hover: transition-shadow bg-white flex flex-col gap-4">
 <h4 className="text-xl font-heading">{t(`acad.esp.${num}.title`)}</h4>
 ...
 <h3 className="text-3xl font-heading mb-8">{t('acad.phil.title')}</h3>
