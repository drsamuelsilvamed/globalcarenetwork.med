...
export function SobreMi() {
 ...
 <div className="text-sm md:text-base font-heading text-gray-300 mt-4 italic border-t border-white/10 pt-4 inline-block max-w-2xl">
 ...
 <div>
 <h4 className="text-base font-heading font-bold text-gray-900 mb-1">{exp.title}</h4>
 ...
 <div>
 <h3 className="text-xl font-heading font-semibold text-[#1A1A1A] mb-3">
 ...
 <p className="text-xl md:text-2xl font-heading font-light leading-relaxed italic text-gray-200">
