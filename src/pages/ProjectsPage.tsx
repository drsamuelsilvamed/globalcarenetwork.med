...
export function ProjectsPage() {
 ...
 >
 <p className="text-xl md:text-2xl font-heading text-gray-700 leading-relaxed max-w-3xl mx-auto font-light">
 ...
 <div>
 <h3 className="text-xl md:text-2xl font-heading text-[#1A1A1A] font-semibold leading-snug">
 {project.title}
 </h3>
