...
export function InnovationPage() {
 ...
 >
 <p className="text-2xl font-heading text-gray-900 leading-relaxed max-w-3xl mx-auto">
 {t('gcn.innov.p1')}
 </p>
 </motion.div>
 </div>
 ...
 >
 <div className="w-16 h-16 bg-inst-blue/10 flex items-center justify-center rounded-full text-inst-blue shrink-0">
 <project.icon className="w-8 h-8" strokeWidth={1.5} />
 </div>
 <div className="flex flex-col gap-4">
 <h3 className="text-2xl md:text-3xl font-heading text-[#1A1A1A]">{project.title}</h3>
