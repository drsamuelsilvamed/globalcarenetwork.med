...
export function QueHago() {
 ...
 <h2 className="text-4xl md:text-5xl lg:text-6xl font-heading tracking-tight mb-6 mt-4">
 {t('quehago.title')}
 </h2>
 </motion.div>
 ...
 <span className="text-gray-400 font-heading text-3xl">{area.id}.</span>
 <h3 className="text-3xl font-heading">{area.title}</h3>
 </div>
