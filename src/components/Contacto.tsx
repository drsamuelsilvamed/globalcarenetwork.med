    ...
    <section id="contacto" className="bg-white text-black py-24 md:py-32 border-t border-gray-200">
      <div className="w-full max-w-4xl mx-auto px-6 md:px-12 flex flex-col items-center text-center">
        ...
        >
          ...
          <div className="w-full max-w-2xl mb-12 text-left bg-brand-cream/35 p-8 rounded-2xl border border-gray-100/50">
          ...
          <a href="mailto:drsamuelsilva.med@gmail.com" className="text-xl md:text-2xl font-serif border-b-2 border-black pb-1 hover:text-gray-600 hover:border-gray-600 transition-all duration-300">
