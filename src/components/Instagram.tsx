    ...
    <section id="instagram" className="bg-brand-cream text-black py-24 md:py-32">
      <div className="w-full max-w-5xl mx-auto px-6 md:px-12 flex flex-col items-center text-center">
        ...
        >
          ...
          <div className="bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-gray-100 max-w-3xl w-full text-left mb-12">
            <p className="text-xl font-serif mb-8 text-center">{t('ig.desc')}</p>
